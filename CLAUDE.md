...
This file provides project-specific guidance for Claude Code when working on the CRM Digital FTE Factory project.
...
- `.claude/skills/` — Reusable skills library

## Code Standards

See `.specify/memory/constitution.md` for code quality, testing, performance, security, and architecture principles.

## CRM Digital FTE Factory Specific Guidelines

### Agent Maturity Model Compliance

This project MUST follow the two-stage evolution:
...
- Test with sample tickets from all channels
- Crystallize requirements in specification

**Stage 2 - Specialization (Hours 17-48):**
- Convert MCP tools to OpenAI Agents SDK @function_tool
- Implement production channel integrations (Gmail, WhatsApp, Web Form)
- Deploy to Kubernetes with PostgreSQL and Kafka
- Achieve >85% test coverage
- Pass 24-hour continuous operation test

### Multi-Channel First

Every component must treat Email, WhatsApp, and Web Form as equal channels:
- Unified customer identification across channels
- Channel-specific response formatting
- Cross-channel conversation continuity
- Channel metadata in all database records

### Skills Library Usage

When implementing features, ALWAYS check `.claude/skills/` for existing skills:
- `gmail-integration` - Email channel setup
- `whatsapp-integration` - WhatsApp/Twilio setup
- `web-form-builder` - React support form (REQUIRED)
- `agent-incubation` - Incubation phase guide
...
- And 7 more utility skills

### Constitutional Principles

All work MUST comply with the 10 principles in `.specify/memory/constitution.md`:
...
- This is a HACKATHON project with 48-72 hour timeline
- Web Support Form is REQUIRED deliverable (not optional)
- Database IS the CRM - no external CRM integrations needed
- Escalation is success, not failure
- Claude Code remains your development partner throughout (builds the Custom Agent)
